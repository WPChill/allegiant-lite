...
if(!function_exists('cpotheme_footer')){
	function cpotheme_footer(){		
		...
		echo '&copy; '.get_bloginfo('name').' '.date("Y").'. '.sprintf(__('Allegiant by <a href="%s" title="Professional WordPress Themes" rel="dofollow">%s</a>.', 'allegiant'), esc_url('https://www.machothemes.com/'), esc_attr('Macho Themes')); 
		echo '</div>';
	}
}
